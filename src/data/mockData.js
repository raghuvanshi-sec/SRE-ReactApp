...
export const mockCustomers = [
  {
    ...
    recentInteractions: [
      { date: '2026-06-05', type: 'Email', text: 'Inquired about multi-region data replication support.' },
      { date: '2026-06-02', type: 'Support Ticket', text: 'Reported API latency spikes in EU-central endpoints.' }
    ],
    digitalTwin: {
      simulatedOutcome: 'Without intervention, 90% probability of churn by June 30.',
      retentionProbability: {
        baseline: 10,
        withDiscount: 45,
        withFeatureGuarantee: 88,
      },
      recommendedPlay: 'Offer 15% discount + priority beta access to Multi-Region sync.',
  ...
  },
  {
    ...
    recentInteractions: [
      { date: '2026-06-04', type: 'Call', text: 'Expressed confusion about automated campaign flow builder.' },
      { date: '2026-05-28', type: 'System Log', text: 'Active users dropped from 15 to 3 in past 2 weeks.' }
    ],
    digitalTwin: {
      simulatedOutcome: 'Will likely downgrade or churn at the next renewal cycle.',
      retentionProbability: {
        baseline: 32,
        withDiscount: 50,
        withOnboardingSession: 92,
      },
      recommendedPlay: 'Schedule dedicated Customer Success onboarding + 1 month free trial extension.',
  ...
  },
  {
    ...
    recentInteractions: [
      { date: '2026-06-06', type: 'Email', text: 'Formal notice requesting SLA penalty refund details.' },
      { date: '2026-06-01', type: 'Service Outage', text: '4-hour downtime in main production DB instance.' }
    ],
    digitalTwin: {
      simulatedOutcome: 'Highly critical. High risk of immediate executive termination.',
      retentionProbability: {
        baseline: 5,
        withDiscount: 15,
        withSlaRefundAndDedicatedTpm: 75,
      },
      recommendedPlay: 'Approve $5,000 SLA penalty rebate + assign dedicated Technical Program Manager.',
  ...
  },
  {
    ...
    recentInteractions: [
      { date: '2026-06-03', type: 'Billing', text: 'Failed credit card payment updated on third attempt.' }
    ],
    digitalTwin: {
      simulatedOutcome: 'Mild risk. Churn possible if competitor contacts them.',
      retentionProbability: {
        baseline: 58,
        withDiscount: 85,
        withDowngradeOption: 95,
      },
      recommendedPlay: 'Suggest downgrade path to Starter plan ($149/mo) with active feature lock.',
  ...
  },
  {
    ...
    recentInteractions: [
      { date: '2026-06-04', type: 'Email', text: 'Requested pricing for adding 50 more seat licenses.' }
    ],
    digitalTwin: {
      ...
      recommendedPlay: 'Introduce new Add-on features (Advanced Security pack).',
...
export const mockAgents = [
  {
    ...
    decisionsToday: 48,
    savedToday: '$18,400',
    capabilities: ['Dynamic discount negotiation', 'Custom feature SLA provisioning', 'CS escalations'],
    systemLogs: [
  ...
  },
  {
    ...
    decisionsToday: 112,
    savedToday: '$12,650',
    capabilities: ['Self-serve plan migration', 'Onboarding assistance', 'Interactive chatbot sessions'],
    systemLogs: [
  ...
  },
  {
    ...
    decisionsToday: 0,
    savedToday: '$0',
    capabilities: ['SLA penalty reconciliation', 'Service credit offers', 'Priority support routing'],
    systemLogs: [
...
export const mockApprovals = [
  {
    ...
    proposedPlay: 'Offer 15% discount for 6 months + priority beta access to Multi-Region sync.',
  ...
  },
  {
    ...
    proposedPlay: 'Approve $5,000 one-time SLA penalty rebate + assign dedicated Technical Program Manager.',
  ...
  },
  {
    ...
    proposedPlay: 'Offer 1 month free trial extension + mandatory onboarding coaching call.',
